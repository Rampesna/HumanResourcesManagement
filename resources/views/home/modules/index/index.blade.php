...
@section('title', 'İnsan Kaynakları Yönetim Sistemi | ')
                ...
                <div class="col-xl-8">
                    <div class="row">
                        <div class="col-xl-6 mb-5">
                            <a href="{{ route('user.web.authentication.login.index') }}" class="card cursor-pointer">
                                <div class="card-body d-flex flex-column flex-center">
                                    <div class="text-center">
                                        ...
                                        <h1 class="fw-bolder text-gray-800 text-center lh-lg mt-5">
                                            Yönetim
                                        </h1>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-6 mb-5">
                            <a href="{{ route('employee.web.authentication.login.index') }}" class="card cursor-pointer">
                                <div class="card-body d-flex flex-column flex-center">
                                    <div class="text-center">
                                        <span class="svg-icon svg-icon-muted svg-icon-5hx">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
@section('customStyles')
    @include('home.modules.index.components.style')
@endsection

@section('customScripts')
    @include('home.modules.index.components.script')
@endsection
