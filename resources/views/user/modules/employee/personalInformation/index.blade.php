...
@section('title', 'Personeller / Kişisel Bilgiler | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Personeller / Kişisel Bilgiler</h1>
        </div>
            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-header border-0">
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">Kişisel Bilgileri Düzenle</h3>
                    </div>
...
@section('customStyles')
    @include('user.modules.employee.personalInformation.components.style')
@endsection

@section('customScripts')
    @include('user.modules.employee.personalInformation.components.script')
@endsection
