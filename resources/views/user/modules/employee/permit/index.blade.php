...
@section('title', 'Personeller / İzinler | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Personeller / İzinler</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.employee.permit.modals.createPermit')
    @include('user.modules.employee.permit.modals.updatePermit')
    @include('user.modules.employee.permit.modals.deletePermit')
...
@section('customStyles')
    @include('user.modules.employee.permit.components.style')
@endsection

@section('customScripts')
    @include('user.modules.employee.permit.components.script')
@endsection
