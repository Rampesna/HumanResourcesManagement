...
@section('title', 'Personeller / Cezalar | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Personeller / Cezalar</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.employee.punishment.modals.createPunishment')
    @include('user.modules.employee.punishment.modals.updatePunishment')
    @include('user.modules.employee.punishment.modals.deletePunishment')
    ...
    <div class="row">
        ...
        <div class="col-xl-3 mb-5 text-end">
            <div class="row">
                <button class="btn btn-primary" onclick="createPunishment()">Yeni Ceza Oluştur</button>
            </div>
        </div>
    </div>
    <div class="row">
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tr class="text-start text-dark fw-bolder fs-7 gs-0">
                            ...
                            <th class="">Tarih</th>
                            <th class="hideIfMobile">Ücret Kesintisi</th>
                        </tr>
                        </thead>
                        <tbody class="fw-bold text-gray-600" id="punishments"></tbody>
                    </table>
                    <hr class="text-muted">
                    <div class="row">
...
@section('customStyles')
    @include('user.modules.employee.punishment.components.style')
@endsection

@section('customScripts')
    @include('user.modules.employee.punishment.components.script')
@endsection
