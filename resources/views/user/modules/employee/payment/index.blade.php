...
@section('title', 'Personeller / Ödemeler | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Personeller / Ödemeler</h1>
        </div>
...
@section('content')
    ...
    @include('user.modules.employee.payment.modals.createPayment')
    @include('user.modules.employee.payment.modals.updatePayment')
    @include('user.modules.employee.payment.modals.deletePayment')
...
@section('customStyles')
    @include('user.modules.employee.payment.components.style')
@endsection

@section('customScripts')
    @include('user.modules.employee.payment.components.script')
@endsection
