            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <div class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    <div class="mb-13 text-center">
                        <h1 class="mb-3">Ödeme Güncelle</h1>
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                        ...
                        <div class="row mb-5">
                            <div class="col-xl-3 mt-3">
                                <label for="update_payment_status_id" class="font-weight-bolder">Ödeme Durumu</label>
                            </div>
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <select id="update_payment_status_id" class="form-select form-select-solid select2Input" data-control="select2" data-placeholder="Ödeme Durumu">
                        ...
                        <div class="row mb-5">
                            <div class="col-xl-3 mt-3">
                                <label for="update_payment_date" class="font-weight-bolder">Ödeme Tarihi</label>
                            </div>
                            <div class="col-xl-9">
                                <div class="form-group">
